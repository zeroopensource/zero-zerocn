// @ts-nocheck
import * as __fd_glob_8 from "../content/docs/zero/zero-official.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content\docs", {"meta.json": __fd_glob_0, }, {"index.mdx": __fd_glob_1, "workspace.mdx": __fd_glob_2, "file/mdx-cheatsheet.mdx": __fd_glob_3, "lib/env.mdx": __fd_glob_4, "lib/packagejson.mdx": __fd_glob_5, "zero/zero-id.mdx": __fd_glob_6, "zero/zero-logo.mdx": __fd_glob_7, "zero/zero-official.mdx": __fd_glob_8, });